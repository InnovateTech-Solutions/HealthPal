...
import 'package:healthpal/src/featuers/profile/controller/profile_controller.dart';
...
import 'package:healthpal/src/featuers/update_profile/view/update_profile.dart';
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Get.to(const UpdateProfileWidget());
                          },

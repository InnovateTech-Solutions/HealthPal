          ...
          builder: ((context, snapShot) {
            if (snapShot.connectionState == ConnectionState.done) {
              if (snapShot.hasData) {
                ...
                final userServue = TextEditingController(
                    text: userData.servue ?? "not medicial History");
                          ...
                          SizedBox(
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...
                                const Gap(15),
                                textFieldLabel('medicial histroy'),
                                FormWidget(
                                  textForm: FormModel(
                                      enableText: false,
                                      controller: userServue,
                                      hintText: 'medicial History',
                                      icon: const Icon(Icons.phone),
                                      invisible: false,
                                      validator: null,
                                      type: TextInputType.name,
